...
import { Banknote, Goal, Search, Send, SquarePen, TimerReset, X, Copy } from "lucide-react";
                            ...
                            <div className={`mt-4`}>
                                ...
                                <div className={`${step == 2 ? 'flex' : 'hidden'} flex-col`}>
                                    ...
                                    <div className={`mt-1`}>
                                        ...
                                        }
                                        {
                                            displayBeneficiaryForm &&
                                            <div className={``}>
                                               <form onSubmit={undefined} className={`space-y-5 gap-6`}>
                                ...
                                <div className={`${confirmStep == 2 ? 'flex' : 'hidden'} flex-col mb-4 -mt-3`}>
                                    <div className={`w-[70%] mx-auto`}>
                                        ...
                                        <p className={`text-base text-center text-black`}>Envoyez le à votre destinataire pour vous faire payer {formatCFA(amountSendToCustomer)} XOF</p>
                                ...
                                <div className={`flex justify-center items-center mb-3`}>
                                    <Button onClick={() => prevStep()} className={`mt-5 w-32 text-sm text-black border border-black bg-transparent hover:text-white mr-3 ${step == 1 || confirmStep == 2 ? 'hidden' : 'block'}`} disabled={isSendLoading}>
                                        Retour
                                    </Button>
                                    <Button onClick={handleSubmit((data) => addNewBeneficiary(data))} className={`mt-5 w-41 text-sm ${step == 2 && displayBeneficiaryForm ? 'block' : 'hidden'}`}>
