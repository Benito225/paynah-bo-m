  ...
  return (
    <div className={`flex flex-col h-full space-y-3`}>
      <div className={`account-list`}>
        <div
          className={`flex p-1 space-x-2.5 2xl:min-h-[10rem] snap-x snap-mandatory overflow-x-auto`}
        >
          <AccountsAction
            lang={lang}
            merchant={merchant}
            ...
            setAccountActionLoading={setAccountActionLoading}
            open={open}
            setOpen={setOpen}
            account={account}
          >
          ...
          <div
            ...
            className={`snap-end shrink-0 w-[40%] 2xl:w-[31%] bg-white flex flex-col justify-between cursor-pointer ${
              selectedAccount == "all" &&
          ...
          >
            <div className={`flex justify-between items-start`}>
              <div>
                <div className={`inline-flex flex-col`}>
                  ...
                  <span className={`text-[11px] font-light text-[#afafaf]`}>
                    PAXXXXXCI
                  </span>
                </div>
              </div>
            ...
            >
              <div className={`inline-flex flex-col`}>
                <h3 className={`text-[10px] font-light text-[#afafaf] -mb-0.5`}>
                  Solde actuel
                </h3>
          ...
          {/* <div onClick={() => setSelectedAccount('2')} className={`snap-end shrink-0 w-[40%] 2xl:w-[31%] bg-white flex flex-col justify-between cursor-pointer ${selectedAccount == '2' && 'outline outline-offset-2 outline-2 outline-[#3c3c3c]'} space-y-6 2xl:space-y-6 p-4 rounded-3xl`}>
                        <div className={`flex justify-between items-start`}>
                            <div>
                                <div className={`inline-flex flex-col`}>
                    ...
                    <div onClick={() => setSelectedAccount('3')} className={`snap-end shrink-0 w-[40%] 2xl:w-[31%] bg-white flex flex-col justify-between cursor-pointer ${selectedAccount == '3' && 'outline outline-offset-2 outline-2 outline-[#3c3c3c]'} space-y-6 2xl:space-y-6 p-4 rounded-3xl`}>
                        <div className={`flex justify-between items-start`}>
                            <div>
                                <div className={`inline-flex flex-col`}>
                                    <div className={`mb-1 rounded-xl p-2 bg-[#f0f0f0] w-[2.7rem] h-[2.7rem] inline-flex justify-center items-center`}>
                    ...
                    <div onClick={() => setSelectedAccount('4')} className={`snap-end shrink-0 w-[40%] 2xl:w-[31%] bg-white flex flex-col justify-between cursor-pointer ${selectedAccount == '4' && 'outline outline-offset-2 outline-2 outline-[#3c3c3c]'} space-y-6 2xl:space-y-6 p-4 rounded-3xl`}>
                        <div className={`flex justify-between items-start`}>
                            <div>
                                <div className={`inline-flex flex-col`}>
                                    <div className={`mb-1 rounded-xl p-2 bg-[#f0f0f0] w-[2.7rem] h-[2.7rem] inline-flex justify-center items-center`}>
