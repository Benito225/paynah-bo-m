...
export default function MobileMoneyActions({lang, sendMoney, beneficiaries, merchant}: MobileMoneyActionsProps) {
    ...
    return (
        <>
            <Dialog>
                ...
                <DialogContent className={`${confirmStep == 0 ? "sm:max-w-[46rem] xl:max-w-[50rem] 2xl:max-w-[53rem]" : "sm:max-w-[40rem]"}  overflow-x-hidden duration-200 !rounded-3xl bg-[#f4f4f7] px-3 py-3`}>
                    <div>
                    ...
                    <div className={`min-h-[6rem] pt-2 pb-4 px-8`}>
                        <Form {...sendMoneyForm}>
                            ...
                            <div className={`${step == 1 ? 'flex' : 'hidden'} items-center justify-between space-x-3`}>
                                <h3 className={`text-sm font-medium`}>1- Choisissez le bénéficiaire</h3>
                            ...
                            <div className={`mt-4`}>
                                    ...
                                    <div className={`w-[70%] mx-auto`}>
                                            ...
                                            <svg className={`h-[4rem] w-auto`} viewBox="0 0 169.57 119">
                                                ...
                                                <p className={`text-sm text-[#707070] mt-3`}>
                                                    <span className={`text-black`}>{`XOF ${sendMoney.getValues('mmAmount')}`}</span>{` à `}
                                                    <span className={`text-black`}>{`${beneficiary?.lastName} ${beneficiary?.firstName}`}</span>{` sur son compte`}
                                                </p>
                                                <p className={`text-sm text-[#707070] mt-3`}><span className={`text-black`}>{`${sendMoney.getValues('mmAccountNumber')}`}</span></p>
                                                ...
                                                <label
                                                    htmlFor="fees"
                                                    className="text-sm text-[#777778] cursor-pointer font-normal leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 gap-2"
                                                >
                                                   Le bénéficiaire paiera les frais <span className={`text-black`}>(1%)</span><br/><span className={'mt-3'}>Le bénéficiaire recevra</span> <span className={`mt-3 text-black`}>{`XOF ${totalAmount}`}</span>
                                                </label>
                                                </div>
                                                <p className={`text-sm text-[#707070] mt-6`}>{`Montant total `}<span className={`text-black`}>{`XOF ${totalAmount}`}</span></p>
                                            </div>
                                    </div>
                                </div>
                                    ...
                                    <div className={`w-[70%] mx-auto`}>
                                            <div className={`flex flex-col items-center`}>
                                                ...
                                                <div className={`w-full mt-12`}>
                                                    ...
                                                    <div className={'mt-6 text-[#e95d5d]'}>
                                                        <p>{errorMessage}</p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className={`${step == 4 ? 'flex' : 'hidden'} flex-col mb-4 -mt-3`}>
                                    <div className={`w-[70%] mx-auto`}>
                                        <div className={`flex flex-col items-center`}>
                                            ...
                                            <p className={`text-base mt-10`}>{`Votre envoi de XOF à X a été traité avec succès !`}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className={`flex justify-center items-center mb-3`}>
                                    ...
                                    <Button onClick={() => downloadTicket()} className={`mt-3 w-48 text-sm ${step == 4 ? 'block' : 'hidden'}`}>
                                        {`Télécharger le reçu`}
                                    </Button>
                                </div>
                            </div>
