                        ...
                        <Form {...sendMoneyForm}>
                            <div className={`mt-4`}>
                                                            ...
                                                            accounts.map((account: IAccount) => (
                                                                <SelectItem key={account.id}
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            className={`mt-[2px]`}>{!account.name || account.name == 'Main' ? "Compte principal" : `${account.name}`} ({account.coreBankId})</span>
                                                                    </div>
                                                                </SelectItem>
                                                            ))
                                                        }
                                ...
                                <div className={`${step == 3 ? 'flex' : 'hidden'} flex-col mb-4 -mt-3`}>
                                    <div className={`w-[70%] mx-auto`}>
                                        <div className={`flex flex-col items-center`}>
                                            <svg className={`w-32 h-auto mt-1`} viewBox="0 0 136.22 124.183">
                                                <defs>
                                            ...
                                            <div className={`w-full mt-12`}>
                                                <div className={`relative`}>
                                                    ...
                                                    <Link className={`text-xs mt-2 hover:font-medium duration-200`}
                                ...
                                <div className={`flex justify-center items-center mb-3`}>
                                    ...
                                    <Button onClick={() => downloadTicket()}
                                            className={`mt-3 w-48 text-sm ${step == 4 ? 'block' : 'hidden'}`}>
                                        {`Télécharger le reçu`}
                                    </Button>
                                </div>
                            </div>
