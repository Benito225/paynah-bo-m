                        ...
                        <Form {...sendMoneyForm}>
                            ...
                            <div className={`mt-4`}>
                                ...
                                <div className={`${step == 2 ? 'flex' : 'hidden'} flex-col mb-4 -mt-3`}>
                                    <div className={`w-[70%] mx-auto`}>
                                            <div className={`flex flex-col items-center`}>
                                                ...
                                                <Select onValueChange={(value) => { setBankAccountId(value); }} defaultValue={bankAccountId}>
                                                                ...
                                                                <SelectContent className={`z-[999] bg-[#f0f0f0]`}>
                                                                    {
                                                                        accounts.map((account: IAccount) => (
                                                                            <SelectItem key={account.id} className={`h-[3.1rem] inline-flex items-center font-light focus:bg-gray-100 cursor-pointer`} value={account.id}>
                                                                                <div className={`inline-flex items-center space-x-2.5`}>
                                                                                    <span className={`mt-[2px]`}>{account.coreBankId}</span>
                                                                                </div>
                                                                            </SelectItem>
                                                                        ))
                                                                    }
                                ...
                                <div className={`${step == 3 ? 'flex' : 'hidden'} flex-col mb-4 -mt-3`}>
                                    <div className={`w-[70%] mx-auto`}>
                                            ...
                                            <svg className={`h-[4rem] w-auto`} viewBox="0 0 169.57 119">
                                                ...
                                                >
                                                   <span className={"text-sm"}>Le bénéficiaire paiera les frais </span><span className={`text-black`}>(1%)</span><br/><span className={'text-xs mt-3'}>Le bénéficiaire recevra</span> <span className={`mt-3 text-black`}>{`XOF ${totalAmount}`}</span>
                                                </label>
                                                </div>
                                                <p className={`text-xs text-[#707070] mt-6`}>{`Montant total `}<span className={`text-black`}>{`XOF ${totalAmount}`}</span></p>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div className={`flex justify-center items-center mb-3`}>
                                    ...
                                    <Button onClick={() => nextStep()} className={`mt-5 w-36 text-sm ${(step == 2 || step == 3 ) ? 'block' : 'hidden'}`}>
                                        Continuer
                                    </Button>
                                    <Button onClick={() => {
                                        // setConfirmStep(1);
                                    ...
                                    <Button onClick={() => downloadTicket()} className={`mt-3 w-48 text-sm ${step == 5 ? 'block' : 'hidden'}`}>
                                        {`Télécharger le reçu`}
                                    </Button>
                                </div>
                            </div>
