...
export default function AccountList({lang, merchant}: AccountListProps) {
    ...
    const showLoader = () => {
        return (
            // <>
            //     <Skeleton
            //         className={`snap-end shrink-0 h-[10.53rem] w-[30%] 2xl:w-[24%] bg-gray-200 flex flex-col justify-between space-y-8 2xl:space-y-8 p-4 rounded-3xl`}>
            //     </Skeleton>
            // </>
            <Skeleton
                ...
                <div className={`flex justify-between items-start`}>
                    ...
                    {/*<Skeleton className={`bg-gray-300 h-5 w-2`} />*/}
                </div>
