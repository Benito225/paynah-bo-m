...
export const TransactionDetailsDropdown = ({
  transaction,
  lang,
  children,
}: DropdownProps) => {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div
          className={`origin-top-right absolute h-auto right-0 w-[95.9rem] shadow-lg ring-1 bg-white ml-8 ring-black ring-opacity-5 ${
            isOpen ? "z-50" : "z-10"
          } mt-6 border-y-2 border-t-0 border-l-2 border-r-2 ${
            transaction.transaction_type.name == "PAYIN"
              ? "border-[#F7D8D8]"
              : "border-[#ACEEFF]"
          } translate-x-9`}
        >
          <div className="py-1 flex text-left">
            <div
              className={`min-h-[6rem] pt-6 pb-7 px-4 bg-white rounded-b-2xl`}
            >
                ...
                <div className=" w-full grid grid-cols-2 gap-3">
                  <div className="col-span-1">
                    ...
                    <div className={`grid grid-flow-col mt-4`}>
                      <div className={`flex-col mr-2`}>
                        <h3
                          className={`font-light text-[#626262] text-xs mb-0.5`}
                        >
                          Type de transaction
                        </h3>
                  ...
                  <div className="col-span-1 ml-10">
                    ...
                    <div className={`grid grid-flow-col mt-4`}>
                      ...
                      <div className={`flex-col mr-2`}>
                        <h3
                          className={`font-light text-[#626262] text-xs mb-1`}
                        >
                          ID Transaction
                        </h3>
                        <span className={`text-sm font-medium leading-4`}>
