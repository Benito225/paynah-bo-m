        ...
        <div>
            ...
            <div className={`fixed inset-x-0 bottom-5 z-[90]`}>
                <div className={`relative`}>
                                    ...
                                    <li className={`flex`}>
                                        <TooltipProvider delayDuration={10}>
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <Link
                                                        className={`inline-flex ${pathname.startsWith(Routes.dashboard.supply.replace('{lang}', lang)) ? 'bg-black' : 'bg-[#fafafa] hover:bg-[#EAEAEA] duration-200'} p-3 rounded-xl aspect-square justify-center items-center`}
                                                        href={Routes.dashboard.supply.replace('{lang}', lang)}>
                                                        <svg className={`w-[1.3rem] ${pathname.startsWith(Routes.dashboard.supply.replace('{lang}', lang)) ? 'fill-white' : 'fill-[#afafaf]'}`}
                                                        ...
                                                        <TooltipTrigger asChild>
                                                            <button type={"submit"}>
                                                                <LogOut strokeWidth={3}
                                                                        className={`w-[1rem] md:w-[1.23rem] text-[#afafaf] hover:text-red-400 duration-200`}/>
                                                            </button>
                                                        </TooltipTrigger>
                                                        <TooltipContent>
                                                            <p className={`text-xs`}>{`Déconnexion`}</p>
                                                        </TooltipContent>
                                                    </Tooltip>
                                                </TooltipProvider>
                                            </form>
                    ...
                    <div className={`max-w-screen-2xl mx-auto px-4 md:px-6 lg:px-8 -mb-5`}>
                        <div className={`bg-[#f4f4f7] py-3 px-6`}>
                        </div>
                        <div className={`bg-[#f4f4f7] py-3 px-6 h-[3rem] z-[-1] absolute top-6 inset-x-0`}>
                        </div>
                    </div>
                </div>
            </div>
