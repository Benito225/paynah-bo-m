                        ...
                        <form onSubmit={stepThreeIndividualProfile.handleSubmit(onSubmitThreeIndividualProfile)} className="">
                            <div className={`grid grid-cols-2 gap-2`}>
                                ...
                                <div>
                                    ...
                                    {/*                <ChakraButton {...rootProps} variant="outline" px="4px" mr="8px">*/}
                                    {/*                    {children}*/}
                                    {/*                </ChakraButton>*/}
                                    {/*            )}*/}
                                    {/*        />*/}
                                    ...
                                    {/*                    <Input type={`text`}*/}
                                    {/*                           className={`pl-6 font-light text-sm ${showConErrorIndividualProfile && "border-[#e95d5d]"}`}*/}
                                    {/*                           placeholder="Téléphone" {...field} style={{*/}
                                    {/*                        backgroundColor: field.value ? '#fff' : '#f0f0f0',*/}
                                    {/*                    }}/>*/}
                                                        {/*<CountrySelector*/}
                                                        {/*    selectedCountry={phoneInput.country.iso2}*/}
                                                        {/*    onSelect={(country) => phoneInput.setCountry(country.iso2)}*/}
                                                        {/*    renderButtonWrapper={({children, rootProps}) => (*/}
                                                        {/*        <ChakraButton type={"button"} {...rootProps} variant="outline" px="4px" mr="8px">*/}
                                                        {/*            {children}*/}
                                                        {/*        </ChakraButton>*/}
                                                        {/*        // <button type={`button`} className={`h-4 w-7`} {...rootProps}>*/}
                                                        {/*        //     {children}*/}
                                                        {/*        // </button>*/}
                                                        {/*    )}*/}
                                                        {/*/>*/}
