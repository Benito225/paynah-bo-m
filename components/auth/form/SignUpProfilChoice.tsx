    ...
    return (
        <div className={`formContainer mx-auto max-w-4xl`}>
            <div className={`text-center mb-10`}>
                <h2 className={`font-semibold text-center text-2xl md:text-3xl mb-3`}>Sélectionnez votre Profil</h2>
            </div>
            <div className={`px-4 mb-[0rem] md:mb-[10.5rem]`}>
                ...
                <div>
                    <Form {...stepTwo}>
                        <form onSubmit={stepTwo.handleSubmit(onSubmitTwo)} className="">
                                            ...
                                            >
                                                <FormItem onClick={() => triggerRadio('individual')} className="flex cursor-pointer items-center justify-center space-x-3 space-y-0">
                                                    <div className={`relative`}>
                                                        ...
                                                        <div className={`${field.value == 'individual' ? 'bg-white border border-black' : 'bg-[#f0f0f0]'} md:h-[12rem] flex items-center rounded-3xl md:rounded-[2.5rem] pt-[1rem] md:pt-8 pb-5 md:pb-9 px-4 text-center relative z-[7]`}>
                                                ...
                                                <FormItem onClick={() => triggerRadio('company')} className="flex cursor-pointer items-center justify-center space-x-3 space-y-0">
                                                    <div className={`relative`}>
                                                        ...
                                                        <div className={`${field.value == 'company' ? 'bg-white border border-black' : 'bg-[#f0f0f0]'} md:h-[12rem] flex items-center rounded-3xl md:rounded-[2.5rem] pt-[1rem] md:pt-8 pb-5 md:pb-9 px-4 text-center relative z-[7]`}>
                                                            <div className={`flex flex-col h-full justify-between items-center`}>
                                                                <div>
                                                ...
                                                <FormItem onClick={() => triggerRadio('ong')} className="flex cursor-pointer items-center justify-center space-x-3 space-y-0">
                                                    <div className={`relative`}>
                                                        ...
                                                        <div className={`${field.value == 'ong' ? 'bg-white border border-black' : 'bg-[#f0f0f0]'} md:h-[12rem] flex items-center rounded-3xl md:rounded-[2.5rem] pt-[1rem] md:pt-8 pb-5 md:pb-9 px-4 text-center relative z-[7]`}>
                                                            <div className={`flex flex-col h-full justify-between items-center`}>
                                                                <div>
                            ...
                            />
                            <div className={`flex flex-col md:flex-row justify-center items-center space-y-1 md:space-x-5 mt-[5rem]`}>
