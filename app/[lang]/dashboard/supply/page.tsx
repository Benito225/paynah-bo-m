...
export default async function SupplyPage({params: { lang }, searchParams}: PaymentLinkProps) {
            ...
            <div className={`max-w-screen-2xl 2xl:max-w-[1600px] mx-auto px-4 md:px-6 lg:px-8 h-full flex flex-col`}>
                <div className={`flex justify-between items-center`}>
                    <div className={`inline-flex items-center space-x-0.5`}>
                        ...
                        <h2 className={`text-base text-black tracking-tight`}>{`Approvisionnement`}</h2>
                    </div>
                ...
                <div className={`flex gap-3 mt-2.5 flex-grow`}>
                    <div className={`w-[72%] 2xl:w-[74%]`}>
                        <SendModeListAndSupplies lang={lang} searchItems={searchItems} merchant={merchant} />
                    </div>
