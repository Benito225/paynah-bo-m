            ...
            <div className={`max-w-screen-2xl 2xl:max-w-[1600px] mx-auto px-4 md:px-6 lg:px-8 h-full flex flex-col`}>
                ...
                <div className={`flex gap-3 mt-2.5 flex-grow`}>
                    ...
                    <div className={`w-[50%] 2xl:w-[53%]`}>
                        <div className={`flex flex-col h-full space-y-3`}>
                            <AccountList lang={lang} merchant={merchant}/>
                            <LastTransactions lang={lang} merchant={merchant} />
                        </div>
                    </div>
                ...
                {/*<div className={`grid grid-cols-12 gap-3 mt-2.5 flex-grow`}>*/}
                ...
                {/*    </div>*/}
                {/*    <div className={`col-span-3`}>*/}
                {/*        <div className={`bg-white h-full rounded-2xl px-6 py-5`}>*/}
                {/*            <div className={`flex items-center justify-between border-b border-[#f1f1f1] pb-1.5 border-dashed`}>*/}
                {/*                <h2 className={`font-medium text-base`}>Points de vente</h2>*/}
                {/*                <div>*/}
                ...
                {/*                    <svg className={`h-[5rem] w-auto`} viewBox="0 0 102.839 102.308">*/}
                {/*                        <defs>*/}
                {/*                            <clipPath id="a-pdv">*/}
